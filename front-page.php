		...
		<div class="content">
			<?php while ( have_posts() ): the_post(); ?>
				...
				<div class="social-btns">  <!-- populate or remove as many of these as you want -->
					...
					<a href="https://www.linkedin.com/in/kenneth-zimny/" class="soc-icon ln"><span class="screen-reader-text">LinkedIn</span></a>
					<!-- <a href="" class="soc-icon db"><span class="screen-reader-text">Dribble</span></a> -->
					<a href="https://github.com/K-Zimny" class="soc-icon gh"><span class="screen-reader-text">GitHub</span></a>
